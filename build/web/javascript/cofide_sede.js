...
function initSedeHotel(){
    var strHTML = "<br><br><br><input id=\"background-color\" type=\"color\" onBlur=\"setColorSede()\"/>";
    document.getElementById("CSH_COLOR_P").innerHTML = strHTML;
}

function setColorSede(){
    document.getElementById("CSH_COLOR_D").value = document.getElementById("background-color").value;
}

<%-- 
    Document   : COFIDE_Curso_search
    Created on : 29-abr-2016, 10:39:00
    Author     : juliocesar
--%>
...
<%
    ...
    String strVendidos = "";
    if (!strCurso.equals(null) || !strCurso.isEmpty()) {
        String strSql = "select *, (CC_MONTAJE - CC_INSCRITOS) as DISPONIBLES from cofide_cursos where CC_NOMBRE_CURSO like '%" + strCurso + "%' order by CC_FECHA_INICIAL";
        ...
        while (rs.next()) {
            ...
            strCursoNombre = rs.getString("CC_NOMBRE_CURSO");
    ...
    <table width="100%" cellspacing="0" cellpadding=30" border="5">
        ...
        <td width="45%">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td class="curso decora02"><%=strCursoNombre%></td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">

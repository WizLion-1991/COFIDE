...
<%
    ...
    if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
        ...
        int intEMP_NO_ISR = 0;
        int intEMP_NO_IVA = 0;
      double dblEMP_RET_IVA_PORC = 0;
      double dblEMP_RET_ISR_PORC = 0;
        ...
        boolean bolTmk = false;
        String strSqlTmk = "select * from usuarios where IS_TMK = 1 and  id_usuarios =" + varSesiones.getIntNoUser();
                    ResultSet rsTmk = oConn.runQuery(strSqlTmk, true);
                    while(rsTmk.next()){
                        bolTmk = true;
                    }
                    rsTmk.close();
...
<html>
    <head>
        ...
        <!--<script type="text/javascript" src="javascript/FuncionesGenericas.js"></script>-->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#dialogGen").dialog({autoOpen: false, draggable: true, modal: true, resizable: true, show: "slide", hide: "slide", width: "500px", height: 150});
                ...
                $("#dialogPCaptura").dialog({autoOpen: false, draggable: true, modal: true, resizable: true, show: 'slide', hide: "slide", width: "auto"});
                ...
                $("#SioNOPagoIns").dialog({autoOpen: false, draggable: true, modal: true, resizable: true, show: 'slide'});
                $("#dialogWait").dialog({autoOpen: false, draggable: true, modal: true, resizable: true, show: 'slide'});
                $("#dialogParticipante").dialog({autoOpen: false, draggable: true, modal: true, resizable: true, show: 'slide'});
        ...
        <!--<script type="text/javascript" src="javascript/GenericAlert.js"></script>-->
        <!--Idioma-->
        <!--Chat en vivo-->
    </head>
    <body oncontextmenu="return false" onload=" MonitorioAgentes();">
        ...
        <div id="dialogGen" title="Basic Title">
            <div id="dialogGen_inside"></div>
        </div>
        ...
        <div id="dialogParticipante" title="Selecciona Participante">
            <div id="dialogParticipante_inside"></div>
        </div>
        ...
        <div id="SioNOPagoIns" title="">
            <input type="hidden" id="Operac" value="">
            <div id="SioNOPagoIns_inside"></div>
            <table>
                <tr>
                    <td><input type="button" name="btnSIPagoIns" id="btnSioNOPagoIns1" value="<bean:message key="main.message48"/>"></td>
                    <td><input type="button" name="btnNOPagoIns" id="btnSioNOPagoIns2" value="<bean:message key="main.message49"/>"></td>
                </tr>
            </table>
        </div>

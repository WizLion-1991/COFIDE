 ...
 * 
 */
@WebServiceClient(name = "InterconectaWsService", targetNamespace = "http://ws.interconecta.tsp.com/", wsdlLocation = "http://cmm.from-la.net:8080/CMM/InterconectaWs?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://cmm.from-la.net:8080/CMM/InterconectaWs?wsdl");

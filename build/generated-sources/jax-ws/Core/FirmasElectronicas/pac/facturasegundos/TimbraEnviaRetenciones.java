...
/**
 * <p>Clase Java para timbraEnviaRetenciones complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="timbraEnviaRetenciones">
 *   &lt;complexContent>
 ...
 *         &lt;element name="cadenaXmlCFDI" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="bytesXmlCFDI" type="{http://www.w3.org/2001/XMLSchema}base64Binary" minOccurs="0"/>
 *         &lt;element name="controlRetimbrado" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="requiereSelladoEmisor" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "timbraEnviaRetenciones", propOrder = {
    "user",
    "userPassword",
    "certificadoEmisor",
    "llavePrivadaEmisor",
    ...
    "bytesXmlCFDI",
    "controlRetimbrado",
    "requiereSelladoEmisor",
    "versionCFDI"
})
public class TimbraEnviaRetenciones {
    ...
    protected String cadenaXmlCFDI;
    @XmlElementRef(name = "bytesXmlCFDI", type = JAXBElement.class)
    protected JAXBElement<byte[]> bytesXmlCFDI;
    protected boolean controlRetimbrado;
    protected boolean requiereSelladoEmisor;
    ...
    /**
     * Obtiene el valor de la propiedad cadenaXmlCFDI.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getCadenaXmlCFDI() {
        return cadenaXmlCFDI;
    }

    /**
     * Define el valor de la propiedad cadenaXmlCFDI.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCadenaXmlCFDI(String value) {
        this.cadenaXmlCFDI = value;
    }
    ...
    /**
     * Obtiene el valor de la propiedad controlRetimbrado.
     * 
     */
    public boolean isControlRetimbrado() {
        return controlRetimbrado;
    }

    /**
     * Define el valor de la propiedad controlRetimbrado.
     * 
     */
    public void setControlRetimbrado(boolean value) {
        this.controlRetimbrado = value;
    }

    /**
     * Obtiene el valor de la propiedad requiereSelladoEmisor.
     * 
     */
    public boolean isRequiereSelladoEmisor() {
        return requiereSelladoEmisor;
    }

    /**
     * Define el valor de la propiedad requiereSelladoEmisor.
     * 
     */
    public void setRequiereSelladoEmisor(boolean value) {
        this.requiereSelladoEmisor = value;
    }

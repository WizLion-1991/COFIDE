...
/**
 * <p>Clase Java para cancelaCFDISectorPrimario complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="cancelaCFDISectorPrimario">
 *   &lt;complexContent>
...
@XmlType(name = "cancelaCFDISectorPrimario", propOrder = {
    "user",
    "userPassword",
    "certificadoEmisor",
    "llavePrivadaEmisor",
...
public class CancelaCFDISectorPrimario {
    ...
    @XmlElementRef(name = "bytesXmlComprobante", type = JAXBElement.class)

...
//    if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
    ...
    String strSql = "select *, (CC_MONTAJE - CC_INSCRITOS) as DISPONIBLES,(select CSH_COLOR from cofide_sede_hotel where CSH_ID = CC_SEDE_ID ) as COLOR_SEDE from cofide_cursos where CC_FECHA_INICIAL >= " + FechaActual + " order by CC_FECHA_INICIAL limit 2";
...
<center>
    <table height="100" border="1" cellpadding="0" border="2" align="center">
        <tbody align="center">
        <td>
        ...
        <td>
            <table height="100" width="400" cellspacing="0" cellpadding="0" border="0">
                    <td align="right"><img src="images/flag_64.png"/></td>
                <tr>

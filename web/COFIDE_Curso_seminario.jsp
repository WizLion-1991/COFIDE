<%-- 
    Document   : COFIDE_Curso_seminario
    Created on : 16-mar-2016, 10:53:27
    Author     : juliocesar
--%>
...
//    if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
    ...
    String strVendidos = "";
    //String strSql = "select * from cofide_cursos where CC_FECHA_INICIAL >= " + FechaActual + " and cc_is_seminario = 1 order by CC_FECHA_INICIAL";
    String strSql = "select *,(CC_MONTAJE - CC_INSCRITOS) as DISPONIBLES from cofide_cursos where CC_FECHA_INICIAL >= " + FechaActual + " and cc_is_seminario = 1 or cc_is_diplomado = 1 order by CC_FECHA_INICIAL";
    ...
    while (rs.next()) {
        ...
        String strDiploSemi = "";
        if (rs.getString("CC_IS_DIPLOMADO").equals("1") && rs.getString("CC_IS_SEMINARIO").equals("0")) {
            strDiploSemi = "Diplomado";
        }
        if (rs.getString("CC_IS_DIPLOMADO").equals("0") && rs.getString("CC_IS_SEMINARIO").equals("1")) {
            strDiploSemi = "Seminario";
        }
        if (rs.getString("CC_IS_DIPLOMADO").equals("1") && rs.getString("CC_IS_SEMINARIO").equals("1")) {
            strDiploSemi = "Diplomado / Seminario";
        }
%>
<center>
    <table width="100%" cellspacing="0" cellpadding=30" border="5">
        ...
        <td width="45%">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td class="detalleCurso decora02"><%=strDiploSemi%></td>
                <br>
                </tr>
                <tr>

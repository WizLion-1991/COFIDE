            ...
            if (ticket.getStrResultLast().equals("OK")) {
               ...
               if (strTipoVta.equals("2") || strTipoVta.equals("3") || strTipoVta.equals("4")) {
                  ...
                  try {
                     ...
                     int intValueKey = Integer.valueOf(ticket.getDocument().getValorKey());
                     String str1 = ticket.generaMail(oConn, intValueKey, strTipoDoc, strPathXML, strPathFonts, "");
                  } catch (NumberFormatException ex) {
                      System.out.println("Error GeneraMail TICKET: " + ex.getLocalizedMessage());
                  }
               }

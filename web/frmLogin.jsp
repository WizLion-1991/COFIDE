...
<html>
    <head>
        ...
        <script>
            function initLogin() {
                document.getElementById("boton1").style.backgroundColor = "99CC00";
                document.getElementById("boton1").style.color = "#000";
            }
        </script>
    </head>
    <body oncontextmenu="return false" onload="initLogin()">

        <div id="portada">
            <div id="letreros">
                <h1>
                    <!--<a href="http://www.solucionesinformaticasweb.com.mx/">-->
                    <a href="https://www.cofide.org/">
                ...
                <html:form action="/login">
                    <table border=0 width="0%" cellpadding="2" class="table2" align="center">
                        ...
                        <tr>
                            <td >
                                <span class="input-group-addon">
                                    <i class="fa fa-user color_user"></i>
                        ...
                        <tr>
                            <td >
                                <span class="input-group-addon">
                                    <i class="fa fa-key color_pass"></i>
                                </span>
                            ...
                            <tr><td align="center" colspan="2">
                                    <i class="fa fa-check-circle color_user">&nbsp;</i><html:submit  styleId="boton1" value="INICIA SESIÓN" styleClass="btn btn-lg" />
                            </td></tr>

<%-- 
    Document   : COFIDE_UpMaterial
    Created on : 13-sep-2016, 13:49:46
    Author     : juliochavez
--%>
...
<%
    ...
    oConn.open();
    String strRutaServer = "//192.168.2.244/www/cofide2017"; //ubicación donde se guardarahn lso documentos
 ...
 /* Get the name attribute value of the <input type="file"> element. */
                        ...
                        String strFileExtension = fileName.substring(fileName.length() - 3, fileName.length());
                        ...
                        if (fileName.toLowerCase().endsWith(".pdf")) {
                            ...
                            String strPathUsado = "";
                            String strNombre = "MaterialCurso_" + strCurso;
                            strPathUsado = strPathBase + "document" + strSeparator + "MaterialCurso" + strSeparator + strNombre + "." + strFileExtension;
//                            String strPathUsado = strRutaServer + strSeparator + "MaterialCurso" + strSeparator + fileName;
 ...
 /* Get the name attribute value of the <input type="file"> element. */
                        ...
                        if (fileName.toLowerCase().endsWith(".pdf") || fileName.toLowerCase().endsWith(".png") || fileName.toLowerCase().endsWith(".jpg")) {
                            ...
                            //Asignamos el nombre del archivo
                            String strPathUsado = strPathBase + "document" + strSeparator + "VideoCurso" + strSeparator + fileName;
                            //Guardamos el archivo
                            System.out.println(strPathUsado);
                            File saveTo = new File(strPathUsado);
                            if (!saveTo.exists()) {
    ...
    if (strID.equals("3")) {
        System.out.println("fotografia del instructor");
        if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
            String strPathBase = this.getServletContext().getRealPath("/");
            String strSeparator = System.getProperty("file.separator");
            if (strSeparator.equals("\\")) {
...
//                strPathBase = strPathBase.replace("\\", "/");
 ...
 /* Get the name attribute value of the <input type="file"> element. */
                        ...
                        if (fileName.toLowerCase().endsWith(".jpeg") || fileName.toLowerCase().endsWith(".png") || fileName.toLowerCase().endsWith(".jpg")) {
                            ...
                            //Asignamos el nombre del archivo
                            String strPathUsado = strPathBase + "document" + strSeparator + "FotografiasInstructores" + strSeparator + fileName;
//                            String strPathUsado = strRutaServer + strSeparator + "FotografiasInstructores" + strSeparator + fileName;
                            System.out.println(strPathUsado);
                            //Guardamos el archivo
                            File saveTo = new File(strPathUsado);
                            if (!saveTo.exists()) {
    ...
    if (strID.equals("4")) {
        System.out.println("CODIGO QR DE LOS CURSOS");
        if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
            String strPathBase = this.getServletContext().getRealPath("/");
            String strSeparator = System.getProperty("file.separator");
            if (strSeparator.equals("\\")) {
 ...
 /* Get the name attribute value of the <input type="file"> element. */
                        ...
                        if (fileName.toLowerCase().endsWith(".jpeg") || fileName.toLowerCase().endsWith(".png") || fileName.toLowerCase().endsWith(".jpg")) {
                            ...
                            if (fileName.contains("\\") && request.getHeader("User-Agent").contains("MSIE")) {
                                fileName = fileName.substring(fileName.lastIndexOf("\\") + 1, fileName.length());
                                System.out.println("entro a ver el use agent");
                            }
                            //Asignamos el nombre del archivo
                            String strPathUsado = strPathBase + "document" + strSeparator + "CODIGO_QR" + strSeparator + fileName;
                            System.out.println(strPathUsado);
                            //Guardamos el archivo
                            File saveTo = new File(strPathUsado);
                            if (!saveTo.exists()) {
 ...
 /* Get the name attribute value of the <input type="file"> element. */
                        ...
                        if (fileName.toLowerCase().endsWith(".png")) {
                            ...
                            //Asignamos el nombre del archivo
                            String strPathUsado = "";
                            String strNombre = "QR_" + strCurso;
                            strPathUsado = strPathBase + "document" + strSeparator + "CODIGO_QR" + strSeparator + strNombre + "." + strFileExtension;
//                            String strPathUsado = strRutaServer + strSeparator + "MaterialCurso" + strSeparator + fileName;
                            System.out.println(strPathUsado);
                            //Guardamos el archivo
                            File saveTo = new File(strPathUsado);

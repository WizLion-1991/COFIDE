    ...
    if (varSesiones.getIntNoUser() != 0 && seg.ValidaURL(request)) {
        ...
        if (strid != null) {
            ...
            if (strid.equals("2")) {
                ...
                System.out.println("-----------fichero f  " + f);
                System.out.println("fichero f.flistFiles " + f.listFiles());
                File[] ficheros = f.listFiles();
                System.out.println("ficheros: " + ficheros);
                System.out.println("tamaño ficheros: " + ficheros.length);
                ...
                atrJSP.atrJSP(request, response, true, true);//Definimos atributos para el XML
                out.println(strXML);//Pintamos el resultado
                System.out.println("mensaje de regreso, xml " + strXML);
            }//Fin ID 2

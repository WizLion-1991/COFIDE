...
public class PriceVolumendemo1 extends ApplicationFrame
{

    public PriceVolumendemo1(String s)
    {
        super(s);
    ...
    {
        PriceVolumendemo1 pricevolumedemo1 = new PriceVolumendemo1("Price Volume Chart demo");

...
public class testFireBird {
   ...
   private static final String URL_DEFAULT = "jdbc:firebirdsql://localhost:3050//Library/Frameworks/Firebird.framework/Versions/A/Resources/examples/empbuild/ASP-RECIBO.FDB";
...
//         }
         ...
         try {
            ...
            System.out.println("Si ejecuto la consulta....");
            ExportaClientes( rs);
         } catch (java.sql.SQLException e) {
...
//         }
   ...
   public void ExportaClientes(ResultSet rs){
      try {
         while(rs.next()){
            System.out.println(" " + rs.getInt("ID_CLIENT") 
                    ...
                    + "|" + rs.getString("PAIS")
                    + "|" + rs.getString("CP")
                    + "|" + rs.getString("CORREO_ELECT")
                    + "|" + rs.getString("CONTACTO")
                    + "|" + rs.getString("FOLIO_FISCAL")
         ...
         Logger.getLogger(testFireBird.class.getName()).log(Level.SEVERE, null, ex);
      }
      
//      "ID_CLIENT of type INTEGER\n" +
//"FOLIO_FISCAL of type INTEGER\n" +
//"TELEFONO of type VARCHAR\n" +
//"RAZON_SOCIAL of type VARCHAR\n" +
//"CALLE of type VARCHAR\n" +
//"NUMEXT of type VARCHAR\n" +
//"NUMINT of type VARCHAR\n" +
//"COLONIA of type VARCHAR\n" +
//"LOCALIDAD of type VARCHAR\n" +
//"REFERENCIA of type VARCHAR\n" +
//"MUNICIPIO of type VARCHAR\n" +
//"ESTADO of type VARCHAR\n" +
//"PAIS of type VARCHAR\n" +
//"CP of type VARCHAR\n" +
//"CORREO_ELECT of type VARCHAR\n" +
//"CONTACTO of type VARCHAR\n" +
//"RFC of type VARCHAR";
   }
   // </editor-fold>
}

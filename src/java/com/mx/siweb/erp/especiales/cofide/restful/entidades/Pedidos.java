...
import com.mx.siweb.erp.restful.entity.*;
...
public class Pedidos {
    ...
    private List<Participantes> lstItemsPart;

    public List<Participantes> getLstItemsPart() {
        return lstItemsPart;
    }

    public void setLstItemsPart(List<Participantes> lstItemsPart) {
        this.lstItemsPart = lstItemsPart;
    }

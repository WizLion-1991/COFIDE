 ...
 */
package com.mx.siweb.mlm.compensacion.xocobenefit;
...
public class CalculoComision extends Comision_MLM {
   ...
   public void doFase3() {
      ...
      String strSql = "select CT_ID,CT_RAZONSOCIAL,CT_UPLINE,CT_PPUNTOS,CT_PNEGOCIO"
              + ",XOCO_ST1_N,XOCO_ST2_N,XOCO_ST3_N,XOCO_ST4_N"
              + ",XOCO_ST1_P,XOCO_ST2_P,XOCO_ST3_P,XOCO_ST4_P "
              + ",XOCO_MES_1,CT_CONTEO_HIJOS,SC_ID,XOCO_MES_2"
              + ",XOCO_SE_NOMBRO_2,XOCO_SE_NOMBRO_3,XOCO_SE_NOMBRO_4,XOCO_SE_NOMBRO_5"
              + ",XOCO_SE_NOMBRO_6,XOCO_SE_NOMBRO_7 "
      ...
      try {
         ...
         while (rs.next()) {
            ...
            cte.setDblValorDbl1(rs.getDouble("XOCO_ST1_N"));
            cte.setDblValorDbl2(rs.getDouble("XOCO_ST2_N"));
            cte.setDblValorDbl3(rs.getDouble("XOCO_ST3_N"));
            cte.setDblValorDbl4(rs.getDouble("XOCO_ST4_N"));
            cte.setDblValorDbl5(rs.getDouble("XOCO_ST1_P"));
            cte.setDblValorDbl6(rs.getDouble("XOCO_ST2_P"));
            cte.setDblValorDbl7(rs.getDouble("XOCO_ST3_P"));
            cte.setDblValorDbl8(rs.getDouble("XOCO_ST4_P"));
            cte.setDblValorDbl9(rs.getDouble("XOCO_MES_1"));
            cte.setDblValorDbl10(rs.getDouble("XOCO_MES_2"));
            ...
            cte.setIntValor2(rs.getInt("XOCO_SE_NOMBRO_2"));
            cte.setIntValor3(rs.getInt("XOCO_SE_NOMBRO_3"));
            cte.setIntValor4(rs.getInt("XOCO_SE_NOMBRO_4"));
            cte.setIntValor5(rs.getInt("XOCO_SE_NOMBRO_5"));
            cte.setIntValor6(rs.getInt("XOCO_SE_NOMBRO_6"));
            cte.setIntValor7(rs.getInt("XOCO_SE_NOMBRO_7"));
...
//         cte.setDblGPuntos(cte.getDblGPuntos() + cte.getDblValorDbl5() + cte.getDblValorDbl6() + cte.getDblValorDbl7() + cte.getDblValorDbl8());
      ...
      for (int i = 0; i < lstMlmCliente.size(); i++) {
         ...
         if (cte.getDblPuntos() != 0
            ...
            strUpdate += "XOCO_ST1_N = " + cte.getDblValorDbl1() + ",";
            strUpdate += "XOCO_ST2_N = " + cte.getDblValorDbl2() + ",";
            strUpdate += "XOCO_ST3_N = " + cte.getDblValorDbl3() + ",";
            strUpdate += "XOCO_ST4_N = " + cte.getDblValorDbl4() + ",";
            strUpdate += "XOCO_ST1_P = " + cte.getDblValorDbl5() + ",";
            strUpdate += "XOCO_ST2_P = " + cte.getDblValorDbl6() + ",";
            strUpdate += "XOCO_ST3_P = " + cte.getDblValorDbl7() + ",";
            strUpdate += "XOCO_ST4_P = " + cte.getDblValorDbl8() + ",";
...
//                              ctePadre.getLstDeta().add(comisDeta);
            ...
            // </editor-fold>
            // <editor-fold defaultstate="collapsed" desc="Calculo de bono de nombramiento">

 ...
 * @author ZeusGalindo
 */
public class MultiLevelPushMenu extends SuperFishMenu{
    ...
    */
   @Override
   public String DrawMenu(Conexion oConn, HttpServletRequest request, HttpServletResponse response, VariableSession varSesiones, ServletContext context) {
      ...
      while (it.hasNext()) {
         ...
         if ((lstMisPermisos.contains(tb.getFieldInt("PS_ID"))
            ...
            if (tb.getFieldInt("PS_ORDEN") == 0) {
               ...
               bolAbreSeccion = true;
               strHTML += "<li >" + chr10;
               strHTML += "<a href=\"#a\"><i class=\"fa fa-book\"></i>" + strMsg + "</a>" + chr10;
               strHTML += "<h2><i class=\"fa fa-book\"></i>" + strMsg + "</h2>" + chr10;
               strHTML += "<ul>" + chr10;
            } else {
